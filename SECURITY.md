...
We always provide security updates for the [latest release](https://github.com/foroughfor/console/releases/latest).
Whenever there is a security update you just need to upgrade to the latest version.

## Reporting a Vulnerability

All security bugs in [foroughfor/console](https://github,com/foroughfor/console) (or other minio/* repositories)
