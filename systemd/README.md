...
- Download the binary. Find the relevant links for the binary https://github.com/foroughfor/console#binary-releases.
...
```
( cd /etc/systemd/system/; curl -O https://raw.githubusercontent.com/foroughfor/console/master/systemd/minio-console.service )
```
